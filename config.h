...
static const char *fonts[]          = { "monospace:size=10", "DejuVu Sans:size=10", "Joy Pixels:pixelsize=10:antialias=true:autohint=true" };
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_F1,                      spawn,          SHCMD("$BROWSER localhost:631/") },
    ...
    { MODKEY,                       XK_F12,                     spawn,          SHCMD("groff -mom /usr/local/share/dwm/narbs.mom -Tpdf | zathura -") },
